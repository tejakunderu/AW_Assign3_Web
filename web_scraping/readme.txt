...
4. Start the Nodejs server using the command "node server.js".
5. Navigate to the http://localhost:8080/ on the browser to view the app.
...
2. Once the installation is complete, modify the wikibooks.py script in AW_Assign3_Web/web_scraping by changing the AWS Elastic Search endpoint to http://localhost:9200/
...
8. Start the Nodejs server using the command "node server.js".
9. Navigate to the link http://localhost:8080/ on the browser to view the app.
